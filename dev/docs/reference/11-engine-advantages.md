...
- 原生 `slot_N.sav` 当前为严格 v5：固定 header、Postcard metadata/state、长度上限和
...
- v5 多槽存档拥有固定 golden、metadata/state 长度校验、双 CRC32、前缀检查和 Program fingerprint；
...
- v5 多槽存档、独立 WebP 预览、`SavedState` 恢复边界和槽外 profile/gallery/settings
  已落地；
